import { View, Text, SafeAreaView, ScrollView, TouchableOpacity, Image, Pressable, Alert, TextInput} from 'react-native';
        ...
        <ScrollView className='flex-1 gap-5 mt-3' automaticallyAdjustKeyboardInsets={true}>
          ...
          <View>
            <TextInput
              ...
              multiline
              style={{backgroundColor: '#fff', padding: 20, borderRadius: 8, fontSize: 16, textAlignVertical: 'top', minHeight: 200 }}
            />
          </View>
