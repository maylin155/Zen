...
const CheckInCard = ({ text, image, onPress }) => {
  return (
    <View className="bg-white rounded-lg p-7 my-2 shadow-md w-200 h-[220px] justify-center">
      <View className="flex-row items-center gap-1">
        ...
        <Image source={image} className="w-40 h-20 rounded-lg" resizeMode="contain"/>
        </View>
      </View>

      <CustomButton title="Write Journal" handlePress={onPress} containerStyles="bg-primary" textStyles="text-md"/>
    </View>
  );
};
